...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // --- パレットをwellSize×wellSizeのウェルに分割 ---
        int wellSize = 2; // ここを2や3に切り替えて使えるように
        int wellsPerRow = N / wellSize; // 1行あたりのウェル数
        int wellCount = wellsPerRow * wellsPerRow; // 全ウェル数

        // --- 仕切り出力（wellSizeごとに1, それ以外0）---
        for (int i = 0; i < N; i++) {
            for (int j = 0; j < N - 1; j++) {
